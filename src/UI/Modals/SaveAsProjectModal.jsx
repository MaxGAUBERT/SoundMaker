...
const SaveAsProjectModal = ({ onClose, onSaveAs }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-10">
      <div style={{backgroundColor: colorsComponent.BackgroundIO, color: colorsComponent.TextIO}} className="p-6 rounded-xl shadow-xl w-full max-w-md relative border">
