...
export const DEFAULT_CHANNELS = [
    { id: 0, name: "Kick",  sampleUrl: DRUM_SAMPLES.kick  },
    { id: 1, name: "Snare", sampleUrl: DRUM_SAMPLES.snare },
    { id: 2, name: "Hihat", sampleUrl: DRUM_SAMPLES.hihat },
    { id: 3, name: "Clap",  sampleUrl: DRUM_SAMPLES.clap  },
];
